...
from easynats.core import Msg, SubscriptionHandler
from easynats.core.msg import MsgImpl
...
class PullConsumerQueue:
    ...
    def __init__(
        ...
        self._inbox = consumer.client.conn.core.new_inbox()
    ...
    async def open(self) -> None:
        ...
        self._subscription_handler = (
            self.consumer.client.conn.core.subscribe_with_callback(
                self._inbox,
