...
from ..api import Error, JetStreamAPIException, JetStreamClient
...
from .consumer import EphemeralPushConsumer, PendingMessage
from .stream import Stream, StreamMessage
...
class KV:
    ...
    @classmethod
    def from_stream(cls, client: JetStreamClient, stream: Stream) -> KV:
    ...
    async def put(
        ...
        Args:
            ...
            last_msg_id: The message ID of the last value stored under this key. If the message ID does not match,
                the put operation will fail.
        """
    ...
    async def create(self, key: str, value: bytes) -> None:
        ...
        Args:
            ...
            value: The value to store.
        """
        await self.put(key, value, last_sequence=0)

    async def update(self, key: str, value: bytes, last_sequence: int) -> None:
        ...
        """
        await self.put(key, value, last_sequence=last_sequence)
    ...
    async def delete(self, key: str, last_sequence: int | None = None) -> None:
