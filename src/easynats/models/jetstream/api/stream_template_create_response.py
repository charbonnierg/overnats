...
class Mirror:
    ...
    """
    subject_transforms: Optional[List[SubjectTransform29]] = None
    """
...
@dataclass
class IoNatsJetstreamApiV1StreamTemplateCreateResponse1:
    """
...
@dataclass
class IoNatsJetstreamApiV1StreamTemplateCreateResponse2:
    """
    A response from the JetStream $JS.API.STREAM.TEMPLATE.CREATE API
    """
...
IoNatsJetstreamApiV1StreamTemplateCreateResponse = Union[
    IoNatsJetstreamApiV1StreamTemplateCreateResponse1,
    IoNatsJetstreamApiV1StreamTemplateCreateResponse2,
]
