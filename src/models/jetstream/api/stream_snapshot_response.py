...
@dataclass
class IoNatsJetstreamApiV1StreamSnapshotResponse1:
    """
...
class Mirror:
    ...
    """
    subject_transforms: Optional[List[SubjectTransform20]] = None
    """
...
@dataclass
class IoNatsJetstreamApiV1StreamSnapshotResponse2:
    """
    A response from the JetStream $JS.API.STREAM.SNAPSHOT API
    """
...
IoNatsJetstreamApiV1StreamSnapshotResponse = Union[
    IoNatsJetstreamApiV1StreamSnapshotResponse1,
    IoNatsJetstreamApiV1StreamSnapshotResponse2,
]
