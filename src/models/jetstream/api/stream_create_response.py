...
class Mirror:
    ...
    """
    subject_transforms: Optional[List[SubjectTransform7]] = None
    """
...
@dataclass
class IoNatsJetstreamApiV1StreamCreateResponse1:
    """
    ...
    mirror: Optional[Mirror3] = None
    """
    Information about an upstream stream source in a mirror
    """
    sources: Optional[List[Source3]] = None
    """
...
@dataclass
class IoNatsJetstreamApiV1StreamCreateResponse2:
    """
    A response from the JetStream $JS.API.STREAM.CREATE API
    """
...
IoNatsJetstreamApiV1StreamCreateResponse = Union[
    IoNatsJetstreamApiV1StreamCreateResponse1, IoNatsJetstreamApiV1StreamCreateResponse2
]
