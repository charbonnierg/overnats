...
class Mirror:
    ...
    """
    subject_transforms: Optional[List[SubjectTransform12]] = None
    """
...
@dataclass
class IoNatsJetstreamApiV1StreamInfoResponse1:
    """
    ...
    mirror: Optional[Mirror5] = None
    """
    Information about an upstream stream source in a mirror
    """
    sources: Optional[List[Source5]] = None
    """
...
@dataclass
class IoNatsJetstreamApiV1StreamInfoResponse2:
    """
    A response from the JetStream $JS.API.STREAM.INFO API
    """
...
IoNatsJetstreamApiV1StreamInfoResponse = Union[
    IoNatsJetstreamApiV1StreamInfoResponse1, IoNatsJetstreamApiV1StreamInfoResponse2
]
