...
class DeliverPolicy13(Enum):
    last = "last"


@dataclass
class Config142:
    deliver_policy: DeliverPolicy13


class DeliverPolicy14(Enum):
    new = "new"


@dataclass
class Config143:
    deliver_policy: DeliverPolicy14


class DeliverPolicy15(Enum):
    by_start_sequence = "by_start_sequence"


@dataclass
class Config144:
    deliver_policy: DeliverPolicy15
    opt_start_seq: int


class DeliverPolicy16(Enum):
    by_start_time = "by_start_time"


@dataclass
class Config145:
    deliver_policy: DeliverPolicy16
    opt_start_time: str


class DeliverPolicy17(Enum):
    last_per_subject = "last_per_subject"


@dataclass
class Config146:
    deliver_policy: DeliverPolicy17
...
@dataclass
class Config148(Config141, Config147):
    ack_policy: AckPolicy
    replay_policy: ReplayPolicy
    deliver_policy: DeliverPolicy
    durable_name: Optional[str] = None
...
@dataclass
class Config149(Config142, Config147):
    ack_policy: AckPolicy
    replay_policy: ReplayPolicy
    deliver_policy: DeliverPolicy13
    durable_name: Optional[str] = None
...
@dataclass
class Config1410(Config143, Config147):
    ack_policy: AckPolicy
    replay_policy: ReplayPolicy
    deliver_policy: DeliverPolicy14
    durable_name: Optional[str] = None
...
@dataclass
class Config1411(Config144, Config147):
    ack_policy: AckPolicy
    replay_policy: ReplayPolicy
    deliver_policy: DeliverPolicy15
    durable_name: Optional[str] = None
...
@dataclass
class Config1412(Config145, Config147):
    ack_policy: AckPolicy
    replay_policy: ReplayPolicy
    deliver_policy: DeliverPolicy16
    durable_name: Optional[str] = None
...
@dataclass
class Config1413(Config146, Config147):
    ack_policy: AckPolicy
    replay_policy: ReplayPolicy
    deliver_policy: DeliverPolicy17
    durable_name: Optional[str] = None
...
Config = Union[Config148, Config149, Config1410, Config1411, Config1412, Config1413]
...
@dataclass
class IoNatsJetstreamApiV1ConsumerCreateResponse1:
    """
...
@dataclass
class IoNatsJetstreamApiV1ConsumerCreateResponse2:
    """
    A response from the JetStream $JS.API.CONSUMER.CREATE API
    """
...
IoNatsJetstreamApiV1ConsumerCreateResponse = Union[
    IoNatsJetstreamApiV1ConsumerCreateResponse1,
    IoNatsJetstreamApiV1ConsumerCreateResponse2,
]
